...
CREATE POLICY "Allow authenticated all operations" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Allow authenticated users to SELECT" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Authenticated Users can Upsert Their Details" ON "public"."profiles" USING (true) WITH CHECK (true);
